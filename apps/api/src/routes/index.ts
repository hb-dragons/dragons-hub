...
import { teamStaffRoutes } from "./admin/team-staff.routes";
import { staffPeopleRoutes } from "./admin/staff-people.routes";
...
import { publicStaffRoutes } from "./public/staff.routes";
import { publicHomeRoutes } from "./public/home.routes";
import { publicAssetsRoutes } from "./public/assets.routes";
import { publicUnsubscribeRoutes } from "./public/unsubscribe.routes";
import { publicProbetrainingRoutes } from "./public/probetraining.routes";
...
import { meStaffRoutes } from "./me/staff.routes";
...
routes.route("/admin", teamStaffRoutes);
routes.route("/admin", staffPeopleRoutes);
...
routes.route("/public", publicStaffRoutes);
routes.route("/public", publicHomeRoutes);
routes.route("/public", publicAssetsRoutes);
routes.route("/public", publicUnsubscribeRoutes);
routes.route("/public", publicProbetrainingRoutes);
