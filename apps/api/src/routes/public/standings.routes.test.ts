...
import { publicStandingsRoutes } from "./standings.routes";
import { errorHandler } from "../../middleware/error";

// Test app without auth middleware
const app = new Hono<AppEnv>();
app.onError(errorHandler);
app.route("/", publicStandingsRoutes);
...
describe("GET /standings (public)", () => {
  it("returns 200 with empty array when no standings exist", async () => {
