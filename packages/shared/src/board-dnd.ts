...
// Mirrors the server-side moveTask reorder so the UI can settle into its final
// layout before the PATCH returns, avoiding the drop-animation fly-back on the
// dragged card.
